...
function AdminDashboard({ user, onLogout }) {
  ...
  const fetchStatistics = async () => {
    ...
    try {
      const result = await ApiService.getDementiaStatistics();
  ...
  const filteredUsers = doctorsList.filter(
    (user) =>
  ...
  const handleAddUser = async (userData) => {
    ...
    try {
      const result = await ApiService.createDoctor(userData);
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      const result = await ApiService.deleteDoctor(userId);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage healthcare professionals in the system
          </p>
        </div>
        ...
        {/* Dementia Classification Statistics */}
        {statistics && statistics.statistics && (
          <div className="mb-8 bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-4">
              Patient Dementia Classification Statistics
            </h2>
